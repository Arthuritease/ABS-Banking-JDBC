...
<h1 style="background-color:black;color:silver; text-align:center">Dear <%out.println(session.getAttribute("name")); %> the recipient username of <%out.println(session.getAttribute("recipientUN")); %> is invalid</h1>
<h2 style="background-color:black;color:silver; text-align:center">Please verify the information provided and try again</h2>
