...
<title>Loan Amount Too High!</title>
</head>
...
<h1 style="background-color:black;color:silver; text-align:center">Dear <%out.println(session.getAttribute("name")); %> </h1>
<h1 style="background-color:black;color:silver; text-align:center">Your loan amount of $<%out.println(session.getAttribute("loanAmt")); %> exceeds your loan ceiling </h1>
