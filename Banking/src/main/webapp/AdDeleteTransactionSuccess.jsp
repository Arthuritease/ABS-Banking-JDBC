...
<h1 style="background-color:black;color:silver; text-align:center">Dear <%out.println(session.getAttribute("adminUN"));%> you have deleted:</h1>


<table id="addeletetrans" style="border: 1px solid black;
  ...
  border-collapse: collapse;">
		...
		<td style="border: 1px solid black;
  border-collapse: collapse;">
			<%out.println(session.getAttribute("transAmt")); %>
		</td>
		<td style="border: 1px solid black;
  border-collapse: collapse;">
			<%out.println(session.getAttribute("transType")); %>
		</td>
		<td style="border: 1px solid black;
  border-collapse: collapse;">
