      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item customerOptions">
          <form action="AdminViewTrans">
				<button class="btn btn-outline-light btn-rounded" type="submit" name="AdminViewTrans">View Transactions</button>
		  </form>
        </li>
...
<h1 style="background-color:black;color:silver; text-align:center">Dear <%out.println(session.getAttribute("adminUN")); %> you have approved the loan application for: </h1>
<table id="rejectedloans" style="border: 1px solid black;
  border-collapse: collapse;"class="table table-dark table-striped table-hover">
	<thead>
	<tr>
		<th style="border: 1px solid black;
  border-collapse: collapse;" class="tableHead">Loan ID: </th>
	</tr>
		
	</thead>
	<tr>
		<td style="border: 1px solid black;
  border-collapse: collapse;"><%out.println(session.getAttribute("loanID")); %></td>
	</tr>
</table>
