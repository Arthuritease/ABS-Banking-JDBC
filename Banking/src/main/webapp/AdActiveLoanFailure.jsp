...
<title>Active Loan Failure</title>
</head>
...
<h1 style="background-color:black;color:silver; text-align:center">Dear <%out.println(session.getAttribute("adminUN"));%></h1>
<h1 style="background-color:black;color:silver; text-align:center">you may not approve this loan as <%out.println(session.getAttribute("loanUN")); %> already has an active loan</h1>
