...
<nav class="navbar navbar-expand-lg navbar-light bg-dark bg-gradient text-white-50">
  <div class="container-fluid">
  	...
  	<a class="navbar-brand mt-2 mt-lg-0" href="CustomerSuccess.jsp">
        <img src="./img/ABS.png" height="30" width="30" ="15"alt="ABS logo"/>
      </a>
...
<h1 style="background-color:black;color:silver; text-align:center"><%out.println(session.getAttribute("name")); %> your new password is now valid</h1>
