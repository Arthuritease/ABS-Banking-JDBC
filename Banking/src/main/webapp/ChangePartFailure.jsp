...
<h1 style="background-color:black;color:silver; text-align:center"><%out.println(session.getAttribute("name")); %> Your request cannot be executed. Please try again</h1>
