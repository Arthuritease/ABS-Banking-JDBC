...
<h1 style="background-color:black;color:silver; text-align:center">Hello <%out.println(session.getAttribute("name"));%> please fill out your particulars </h1>
<div class="updatePart">
	<form action="ChangeParticulars">
	<table style="color:salmon">
		<tr>
			<td style="color:silver; font-size:30px; font-family:monospace">name: </td><td><input type="text" name="newName" placeholder="new name" required></td>
		</tr>
		<tr>
			<td style="color:silver; font-size:30px; font-family:monospace">email: </td><td><input type="text" name="newEmail" placeholder="new email" required></td>
		</tr>
		<tr>
			<td style="color:silver; font-size:30px; font-family:monospace">Security Question:<select class="secQ"><option style="font-size:20px" value="favFood">Food</option><option style="font-size:20px" value="favBand">Band</option><option style="font-size:20px" value="hometown">City</option><option style="font-size:20px" value="favCar">Car</option></select></td>
		</tr>
		<tr>
			<td style="color:silver; font-size:30px; font-family:monospace">Secuirty Answer: </td><td><input type="text" name="secA" placeholder="new answer" required></td>
		</tr>

	</table>
	<button class="btn btn-outline-danger" type="submit" value = "ChangeParticulars">Change</button>
</form>
</div>
