...
<h1 style="background-color:black;color:silver; text-align:center">Congratulations <%out.println(session.getAttribute("name")); %> your transfer is successful</h1>

<table id="fundtransfersuccess" style="border: 1px solid black;
  border-collapse: collapse;"class="table table-dark table-striped table-hover">
	<thead>
		<tr>
			<th style="border: 1px solid black;
  border-collapse: collapse;" class="tableHead">Recipient Username</th>
			<th style="border: 1px solid black;
  border-collapse: collapse;" class="tableHead">Fund amount: </th>
		</tr>
	</thead>
	<tr style="border: 1px solid black;
  border-collapse: collapse;">
		<td style="border: 1px solid black;
  border-collapse: collapse;"><%out.println(session.getAttribute("recipientUN"));%></td>
		<td style="border: 1px solid black;
  border-collapse: collapse;"><%out.println(session.getAttribute("amtToPrint"));%></td>
	</tr>
</table>
