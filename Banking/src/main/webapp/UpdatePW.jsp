...
<h1 style="background-color:black;color:silver; text-align:center">Hello <%out.println(session.getAttribute("name"));%> please fill out the form </h1>

<div class=changePW>
	<form action="ChangeUN">
	<table>
		<tr>
			<td style="color:silver; font-size:40px; font-family:monospace">New password: </td><td><input type="text" name="newPW" placeholder="new password"></td>
		</tr>
		<tr>
			<td style="color:silver; font-size:40px; font-family:monospace">Re-enter: </td><td><input type="text" name="rePW" placeholder="Re-enter"></td>
		</tr>
		<tr>
			<td style="color:silver; font-size:40px; font-family:monospace">Security Answer: </td><td><input type="text" name="secA" placeholder="Security Answer"></td>
		</tr>

	</table>
	<button class="btn btn-outline-danger" type="submit" value = "changePW">Change</button>
</form>
</div>
<div class="image-container">
	<div class="loginbg-image"></div>
</div>
