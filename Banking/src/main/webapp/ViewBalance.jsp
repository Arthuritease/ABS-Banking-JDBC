...
<h1 style="background-color:black;color:salmon; text-align:center"><%out.println(session.getAttribute("name")); %> Your Balance are as follows: </h1>
<h2 style="background-color:black;color:salmon; text-align:center"><%out.println(session.getAttribute("bal")); %></h2>
<span style="background-color: white"><a href="CustomerSuccess.jsp">Return </a>to Dashboard</span>
