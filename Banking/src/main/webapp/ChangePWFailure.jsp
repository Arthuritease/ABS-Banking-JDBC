...
<h1 style="background-color:black;color:silver; text-align:center">Dear <%out.println(session.getAttribute("name")); %> your new passwords did not match.</h1>
<h1 style="background-color:black;color:silver; text-align:center">Make sure you entered correctly.</h1>
