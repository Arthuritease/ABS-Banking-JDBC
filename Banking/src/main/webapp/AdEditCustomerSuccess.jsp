...
<h1 style="background-color:black;color:silver; text-align:center">Dear <%out.println(session.getAttribute("adminUN"));%> new details of the customer are as follows:</h1>


<table id="adeditcussuccess" style="border: 1px solid black;
